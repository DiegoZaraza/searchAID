# AID for AIDS 
Project designed for the automation of the website [AID for AIDS](https://aidforaids.org/)
...
Git:
    ...
    Whit SSH
    git clone git@github.com:DiegoZaraza/searchAID.git
    cd searchAID
...
Or simply [download a zip](https://github.com/DiegoZaraza/searchAID/archive/refs/heads/main.zip) file
